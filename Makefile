...
main: CApp.cpp
	$(CC) $(CPPFLAGS) -c CAnimation.cpp CApp.cpp CApp_OnCleanup.cpp CApp_OnEvent.cpp CApp_OnInit.cpp CApp_OnLoop.cpp CApp_OnRender.cpp CArea.cpp CCamera.cpp CEntity.cpp CEvent.cpp CFPS.cpp CMap.cpp CSamus.cpp CSurface.cpp CTile.cpp CEntityCol.cpp CTurtle.cpp CInsect.cpp CSimon.cpp CApp_OnTitle.cpp CApp_OnGameOver.cpp CShot.cpp CExplode.cpp CSkeleton.cpp CWhip.cpp CSword.cpp  CDog.cpp CSoundBank.cpp
